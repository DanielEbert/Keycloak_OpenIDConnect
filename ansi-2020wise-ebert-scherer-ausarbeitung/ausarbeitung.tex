...
Der \textit{Authorization Code Flow} wird in der nächsten Sektion ausführlich beschrieben, da dieser am besten zum Use Case unseres praktischen Beispiels passt und der meist verwendete Ablauf ist.
...
\subsubsection{Registrierung der \texttt{redirect\_uri}}
...
Daher muss das Access Token über den Authorization: Bearer Header gesendet werden. In Keycloak wird die Authentifizierung über Authorization Header erzwungen \cite{keycloakDocs}.
...
Der Authorization Server ist die komplexeste Komponente im SSO-System und daher am schwersten zu sichern. In dieser Sektion werden Schwachstellen präsentiert und gezeigt wie diese mitigiert werden müssen.
...
% OAuth in Action chapter 10
% Eventuell die Basic Keycloak threats hinzufügen, wie IP/Port Restriction
