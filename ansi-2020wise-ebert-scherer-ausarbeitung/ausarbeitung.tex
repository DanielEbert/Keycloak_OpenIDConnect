...
% Die geschützten Ressourcen des Servers sind in mehrfacher Hinsicht verwundbar. Die erste und offensichtlichste ist, dass Access Tokens durchsickern können, wodurch ein Angreifer Daten über geschützte Ressourcen erhält. Dies kann durch Token-Hijacking geschehen, wie bereits in der vorigen Sektion gezeigt wurde oder das Token eine schwache Entropie hat. \cite{OAuth2inAction}

% \subsubsection{Endpunktschwachstellen}
...
% Eventuell CORS noch hinzufügen
