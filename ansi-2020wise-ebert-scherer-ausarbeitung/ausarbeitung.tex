...
In den Sektionen der vorherigen Sektionen wurde präsentiert, wie Access Token aus Clients gestohlen werden können. Bearer-Access Token für Clients sind transparent, damit keine kryptographischen Operationen durchgeführt werden müssen. Gelangt ein Angreifer an ein Access Token, ist er in der Lage, auf alle Ressourcen zuzugreifen, die in den Anwendungsbereich dieses speziellen Tokens fallen.
...
\begin{itemize}
	...
	\item Token Redirect: Ein Angreifer verwendet ein Access-Token, das für einen bestimmten Ressourcenserver generiert wurde, um Zugriff auf einen anderen Ressourcenserver zu erhalten, der fälschlicherweise glaubt, dass das Token für ihn gültig ist. \cite{RFC6750}
