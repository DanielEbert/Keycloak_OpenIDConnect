\chapter{Einleitung} \label{EB_Einleitung}
...
\section{Motivation} % vielleicht keine subsections?
...
\chapter{Aufbau von SSO}

\section{Teilnehmer/Rollen}

\subsection{End-User} \label{EB_End-User}
...
\subsection{Access Token} \label{EB_AccessToken}
...
\subsection{Authentifizierung eines Users}
...
\subsection{Zugriff auf geschützte Ressourcen} \label{EB_Zugriff auf geschützte Ressourcen}
...
\subsection{Validieren des Access Token}
