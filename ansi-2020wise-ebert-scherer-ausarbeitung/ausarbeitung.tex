...
Jedoch sollte nicht alleine auf HSTS vertraut werden, da es User-Agents gibt, die diesen Header nicht unterstützen und daher in den Produktion nur HTTPS, beziehungsweise TLS, eingesetzt werden.
