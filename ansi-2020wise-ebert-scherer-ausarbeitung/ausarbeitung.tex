...
% client secret beim token exchange? - Sebastian: client_secret + authorization code = access token
% TODO wo speichern wir das client_secret - wichtig für threat model: Client Impersonation
